...
type (
	...
	OracleProcessProposal func(ctx sdk.Context, req *abci.RequestProcessProposal, log log.Logger) (*abci.ResponseProcessProposal, error)
	OracleExtendVote      func(ctx sdk.Context, req *abci.RequestExtendVote, log log.Logger) (*abci.ResponseExtendVote, error)
	OracleVerifyVote      func(ctx sdk.Context, req *abci.RequestVerifyVoteExtension, log log.Logger) (*abci.ResponseVerifyVoteExtension, error)
	OraclePreBlocker      func(ctx sdk.Context, req *abci.RequestFinalizeBlock, log log.Logger) error
)
