...
func init() {
	proto.RegisterType((*RandomResult)(nil), "glnro.oracle.v1.RandomResult")
}

func init() { proto.RegisterFile("glnro/oracle/v1/types.proto", fileDescriptor_7239aaadd7d47f17) }
